    ...
    public static class DbSeeder
    {
        ...
        private static async Task SeedUsers(ApplicationDbContext context)
        {
            ...
            if (!await context.Users.AnyAsync(u => u.Username == "Mayfair39"))
            {
                ...
                user.PasswordHash = passwordHasher.HashPassword(user, "Mayfair1");
                context.Users.Add(user);
            }
        ...
        private static async Task SeedParticipations(ApplicationDbContext context)
        {
            ...
            if (briceag == null) return;

            var pastEventTitles = new[]
            {
                "Flower Market",
                "Fun Craft Workshop",
                "Photography Walk",
            ...
            foreach (var title in pastEventTitles)
            {
                ...
                context.EventRegistrations.Add(new EventRegistration
                {
                    UserId = briceag.Id,
                    EventId = ev.Id,
                    RegisteredAt = ev.EventDate.AddDays(-5),
                    Status = "Registered",
        ...
        private static async Task SeedCategories(ApplicationDbContext context)
        {
            ...
            {
                new Category { Name = "Conference", Description = "Professional conferences, business talks, and formal speaking events." },
                new Category { Name = "Food & Drinks", Description = "Dining experiences, tastings, brunches, dinners, and drink-related events." },
                new Category { Name = "Technology", Description = "Tech events, innovation meetups, AI sessions, and digital industry gatherings." },
                new Category { Name = "Exhibition", Description = "Art exhibitions, gallery openings, and curated cultural showcases." },
                new Category { Name = "Market", Description = "Local markets, fashion markets, flower fairs, and shopping-style community events." },
                new Category { Name = "Workshop", Description = "Hands-on workshops, creative sessions, and educational practical activities." },
                new Category { Name = "Festival", Description = "Seasonal festivals, outdoor celebrations, and large-scale themed public events." },
                new Category { Name = "Networking", Description = "Business networking sessions, professional mixers, and connection-building events." },
                new Category { Name = "Social", Description = "Casual social events, parties, openings, and community gatherings." }
            };
        ...
        private static async Task SeedEvents(ApplicationDbContext context)
        {
            ...
            if (eventraStudios == null || theLobby == null || mayfair39 == null)
                return;

            var conferenceCategory = await context.Categories.FirstOrDefaultAsync(c => c.Name == "Conference");
            ...
            var events = new List<Event>
            {
                new Event
                {
                    ...
                    CategoryId = socialCategory?.Id ?? 0, OrganizerId = eventraStudios.Id,
                ...
                new Event
                {
                    ...
                    SupportEmail = "eventra@gmail.com", SupportPhone = "0712345678",
                    CategoryId = techCategory?.Id ?? 0, OrganizerId = eventraStudios.Id,
                    Status = "Approved", CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow, ApprovedAt = DateTime.UtcNow
                },
                new Event
                {
                    ...
                    SupportEmail = "eventra@gmail.com", SupportPhone = "0712345678",
                    CategoryId = exhibitionCategory?.Id ?? 0, OrganizerId = eventraStudios.Id,
                    Status = "Approved", CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow, ApprovedAt = DateTime.UtcNow
                },
                new Event
                {
                    ...
                    SupportEmail = "eventra@gmail.com", SupportPhone = "0712345678",
                    CategoryId = marketCategory?.Id ?? 0, OrganizerId = eventraStudios.Id,
                    Status = "Approved", CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow, ApprovedAt = DateTime.UtcNow
                },
                new Event
                {
                ...
                new Event
                {
                    ...
                    SupportEmail = "eventra@gmail.com", SupportPhone = "0712345678",
                    CategoryId = conferenceCategory?.Id ?? 0, OrganizerId = eventraStudios.Id,
                    Status = "Approved", CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow, ApprovedAt = DateTime.UtcNow
                },
                new Event
                {
                    ...
                    CategoryId = foodCategory?.Id ?? 0, OrganizerId = theLobby.Id,
                    Status = "Approved", CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow, ApprovedAt = DateTime.UtcNow
                },
                new Event
                {
                ...
                new Event
                {
                    ...
                    SupportEmail = "eventra@gmail.com", SupportPhone = "0712345678",
                    CategoryId = workshopCategory?.Id ?? 0, OrganizerId = eventraStudios.Id,
                    Status = "Approved", CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow, ApprovedAt = DateTime.UtcNow
                },
                new Event
                {
                ...
                new Event
                {
                    ...
                    SupportEmail = "eventra@gmail.com", SupportPhone = "0712345678",
                    CategoryId = festivalCategory?.Id ?? 0, OrganizerId = eventraStudios.Id,
                    Status = "Approved", CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow, ApprovedAt = DateTime.UtcNow
                },
                new Event
                {
                    ...
                    SupportEmail = "eventra@gmail.com", SupportPhone = "0712345678",
                    CategoryId = networkingCategory?.Id ?? 0, OrganizerId = eventraStudios.Id,
                    Status = "Approved", CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow, ApprovedAt = DateTime.UtcNow
                },
                new Event
                {
                ...
                new Event
                {
                    ...
                    CategoryId = foodCategory?.Id ?? 0, OrganizerId = mayfair39.Id,
                    Status = "Approved", CreatedAt = DateTime.UtcNow, UpdatedAt = DateTime.UtcNow, ApprovedAt = DateTime.UtcNow
                },
                new Event
                {
        ...
        private static async Task SeedNotifications(ApplicationDbContext context)
        {
            ...
            if (gardenParty == null) return;

            bool exists = await context.Notifications.AnyAsync(n =>
                n.UserId == briceag.Id &&
                n.RelatedEventId == gardenParty.Id &&
                n.Type == "NewEventFromOrganizer");
            ...
            if (!exists)
            {
                context.Notifications.Add(new Notification
                {
                    ...
                    Message = $"Eventra Studios published a new event: \"{gardenParty.Title}\".",
                    Type = "NewEventFromOrganizer",
                    RelatedEventId = gardenParty.Id,
                    IsRead = false,
                    CreatedAt = DateTime.UtcNow
                });
